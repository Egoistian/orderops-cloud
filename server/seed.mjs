...
const orders = [
  ["sf-1001", "tenant-seoul-fresh", "SF-20260711-001", "2026-07-11T00:35:00+09:00", "김*현", "010-****-4821", "서울 강남구", "연어 스테이크", 2, "냉장", "high", "ready", [], ["전화번호 형식 통일", "서울 권역 냉장 라인 자동 배정"], "성수 냉장센터", "냉장 B-02", 56800, 3],
  ["sf-1002", "tenant-seoul-fresh", "SF-20260711-002", "2026-07-11T00:12:00+09:00", "이*원", "010-****-1903", "경기 성남시", "새벽 샐러드 세트", 1, "수도권 당일", "review", "exception", ["주소확인"], ["상세 주소 누락 감지", "출고 전 검수 필요"], "판교 허브", "주소 확인 대기", 24900, 2],
  ["sf-1003", "tenant-seoul-fresh", "SF-20260710-019", "2026-07-10T16:40:00+09:00", "박*정", "010-****-7730", "서울 마포구", "유기농 과일 박스", 1, "파손주의", "normal", "normalized", [], ["고객명 공백 제거", "파손주의 키워드 분류"], "마포 MFC", "완충 포장 F-01", 41900, 1],
  ["sf-1004", "tenant-seoul-fresh", "SF-20260710-018", "2026-07-10T15:58:00+09:00", "최*우", "010-****-5512", "인천 연수구", "냉동 간편식 6종", 2, "냉장", "normal", "received", [], ["원본 주문 수신", "정규화 대기"], "인천 저온센터", "미배정", 73200, 1],
  ["sf-1005", "tenant-seoul-fresh", "SF-20260710-017", "2026-07-10T15:10:00+09:00", "정*아", "010-****-8066", "서울 송파구", "저당 베이커리", 3, "일반택배", "low", "shipped", [], ["주소 표준화 완료", "일반택배 허브 배정"], "송파 MFC", "CJ-SEOUL-4", 38700, 5],
  ["sf-1006", "tenant-seoul-fresh", "SF-20260710-016", "2026-07-10T14:32:00+09:00", "유*민", "010-****-3304", "경기 고양시", "프리미엄 정육 세트", 1, "냉장", "high", "ready", [], ["냉장 상품 태그 감지", "수도권 북부 라인 배정"], "고양 냉장센터", "냉장 B-04", 129000, 2],
  ["bc-2001", "tenant-busan-craft", "BC-20260711-041", "2026-07-11T00:28:00+09:00", "한*진", "010-****-2408", "부산 수영구", "수제 머그 세트", 2, "파손주의", "high", "ready", [], ["파손주의 상품 자동 감지", "완충 포장 라인 배정"], "부산 동부센터", "완충 P-03", 64000, 2],
  ["bc-2002", "tenant-busan-craft", "BC-20260711-040", "2026-07-11T00:05:00+09:00", "문*서", "010-****-9910", "경남 창원시", "라탄 수납 바구니", 1, "대형화물", "review", "exception", ["연락처확인"], ["연락처 자리수 검수 플래그", "대형화물 라인 임시 보류"], "창원 화물허브", "연락처 확인 대기", 89000, 1],
  ["bc-2003", "tenant-busan-craft", "BC-20260710-039", "2026-07-10T17:02:00+09:00", "서*훈", "010-****-4027", "부산 해운대구", "핸드메이드 조명", 1, "파손주의", "normal", "normalized", [], ["도로명 주소 표준화", "취급주의 라인 추천"], "부산 동부센터", "완충 P-02", 118000, 1],
